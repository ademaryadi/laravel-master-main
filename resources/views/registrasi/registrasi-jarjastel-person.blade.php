        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-4">
                ...
                <div class="col-xl-6 fv-row">
                        ...
                        <input class="form-control form-control-lg form-control @error('phone') is-invalid @enderror" type="text" placeholder="Masukan No. Telepon Penanggung Jawab" id="phone" name="phone" value="{{ old('phone') }}" maxlength="13" autocomplete="off" required/>
                        @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
