                ...
                <form class="form" id="kt_stepper_form_jartel" th:method="post">
                    ...
                    <div class="flex-column current" data-kt-stepper-element="content">
                        ...
                        <label class="col-form-label fw-bold mb-2" 
                            id= "namaPerusahaanText" value="<?php echo e($perusahaan['nama']); ?>"
                            text="<?php echo e($perusahaan['nama']); ?>"><?php echo e($perusahaan['nama']); ?>
                        ...
                        <label class="col-form-label fw-bold" 
                            id= "nomorNIBText" value="<?php echo e(auth()->user()->nib); ?>"
                            text="<?php echo e(auth()->user()->nib); ?>"><?php echo e(auth()->user()->nib); ?></label>
                        </div>
                        </div>									   
                        <div class="form-group row">
                        ...
                        <label  class="col-form-label fw-bold"
                            id="pemohonText" value="<?php echo e($pemohon['nama']); ?>"
                            text="<?php echo e($pemohon['nama']); ?>"><?php echo e($pemohon['nama']); ?></label>
                        </div>
                        </div>									   
                        <div class="form-group row">
                        ...
                        <span>:</span>
                        <label  class="col-form-label fw-bold"
                            id="jabatanText" value="<?php echo e($pemohon['jabatan']); ?>"
                            text="<?php echo e($pemohon['jabatan']); ?>"><?php echo e($pemohon['jabatan']); ?></label>
                        </div>
                        </div>	
...
<?php /**PATH C:\Users\Ade Maryadi\Documents\GitHub\laravel-master-main\resources\views/perizinan/form-perizinan.blade.php ENDPATH**/ ?>