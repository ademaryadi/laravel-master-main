...
<div class="card">
    ...
    <form id="kt_project_settings_form" class="form" action="<?php echo e(url('proses-perusahaan')); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body p-9">
            <div class="row mb-4">
                <div class="col-xl-6 fv-row">
                        ...
                        <input class="form-control form-control-lg form-control-solid <?php $__errorArgs = ['nib'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(auth()->user()->nib); ?>" readonly type="text" placeholder="" id="nib" name="nib" autocomplete="off" required/>
                        <?php $__errorArgs = ['nib'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-xl-6 fv-row">
                        ...
                        <input class="form-control form-control-lg form-control <?php $__errorArgs = ['nib_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="file" placeholder="" id="nib_file" name="nib_file" autocomplete="off" accept="application/pdf" required/>
                        <?php $__errorArgs = ['nib_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-lg form-control <?php $__errorArgs = ['nama_perusahaan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" placeholder="" id="nama_perusahaan" name="nama_perusahaan" value="<?php echo e(old('nama_perusahaan')); ?>"  autocomplete="off" />
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row mb-4">
                <div class="col-xl-12 fv-row">
                        ...
                        <select name="jenis_perusahaan" id="jenis_perusahaan" class="form-control form-control-lg form-control <?php $__errorArgs = ['jenis_perusahaan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = $jenis_perusahaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_jenis_perusahaan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($data_jenis_perusahaan->id); ?>"><?php echo e($data_jenis_perusahaan->jenis_perusahaan); ?></option>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['jenis_perusahaan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" id="phone" name="phone" value="<?php echo e(old('phone')); ?>"  autocomplete="off" required/>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row mb-4">
                <div class="col-xl-6 fv-row">
                    ...
                    <input class="form-control form-control-lg form-control <?php $__errorArgs = ['npwp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" id="npwp" name="npwp" autocomplete="off" accept="application/pdf"/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-xl-6 fv-row">
                    ...
                    <input class="form-control form-control-lg form-control <?php $__errorArgs = ['npwp_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="file" id="npwp_file" name="npwp_file" autocomplete="off" accept="application/pdf"/>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-lg form-control <?php $__errorArgs = ['domisili'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="file" id="domisili" name="domisili"autocomplete="off" accept="application/pdf"/>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-lg form-control <?php $__errorArgs = ['surat_kuasa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="file" id="surat_kuasa" name="surat_kuasa" autocomplete="off" accept="application/pdf"/>
                <?php $__errorArgs = ['surat_kuasa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row mb-7">
                <div class="col-xl-6 fv-row">
                    ...
                    <input class="form-control form-control-lg form-control <?php $__errorArgs = ['dasar_hukum'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="file" id="dasar_hukum" name="dasar_hukum" autocomplete="off" accept="application/pdf"/>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-xl-6 fv-row">
                    ...
                    <input class="form-control form-control-lg form-control <?php $__errorArgs = ['sk_kemenkumham'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="file" id="sk_kemenkumham" name="sk_kemenkumham" autocomplete="off" accept="application/pdf"/>
                    <?php $__errorArgs = ['sk_kemenkumham'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ade Maryadi\Documents\GitHub\laravel-master-main\resources\views/registrasi/registrasi-jarjastel-perusahaan.blade.php ENDPATH**/ ?>