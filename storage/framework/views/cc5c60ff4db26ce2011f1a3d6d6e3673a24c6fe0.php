                    ...
                    <table id="kt_datatable_permohonan_perizinan" class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-120px">Tanggal Pengajuan</th>
                                <th class="min-w-120px">KBLI</th>
                                <th class="min-w-250px">Nama Izin</th>
                                <th class="min-w-250px">Batas Verifikasi</th>
...
<?php if (! $__env->hasRenderedOnce('ca4f4612-bd7e-42ce-bad4-a2dca872545f')): $__env->markAsRenderedOnce('ca4f4612-bd7e-42ce-bad4-a2dca872545f'); ?>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ade Maryadi\Documents\GitHub\laravel-master-main\resources\views/dashboard.blade.php ENDPATH**/ ?>